  ...
  return (
    <section className={styles.section} id="clinicians-cta">
      <div className={styles.container}>
        <h2 className={styles.title}>When You&apos;re Ready We&apos;re Here.</h2>
        <p className={styles.subtitle}>
          We believe the first step toward healing. With compassionate care and evidence-based approaches,
